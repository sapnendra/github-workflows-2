            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-6 hover:shadow-2xl transition-all duration-300">
                ...
                <div className="space-y-4">
                  {Object.entries(statusData.clientsByStatus || {}).map(
                    ([status, statusClients]) => {
                      ...
                      return (
                        <div
                          key={status}
                          className={`border-l-4 ${color} pl-4 py-3 rounded-r-lg hover:shadow-md transition-all duration-200`}
                        >
                          ...
                          <div className="space-y-1.5 mt-2">
                            {statusClients.slice(0, 3).map((client) => (
                              <div
                                key={client._id}
                                className="flex items-center space-x-2 text-xs text-gray-600 dark:text-gray-400 font-medium hover:text-gray-900 dark:hover:text-gray-200 transition-colors"
                              >
